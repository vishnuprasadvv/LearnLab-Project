...
const AdminPage = () => {
  ...
  return (
    ...
    <div className="flex flex-col gap-2 border p-3 bg-gray-50 bg-opacity-50 w-[20%] h-[100%] fixed z-10 overflow-y-auto">
    <div className="hidden md:block uppercase font-bold text-gray-600 text-xl">ADMIN DASHBOARD </div>
