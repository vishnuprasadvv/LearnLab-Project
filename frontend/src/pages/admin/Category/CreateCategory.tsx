...
const CreateCategory = () => {
    ...
    const formik = useFormik({
        ...
        onSubmit : async(values) => {
          ...
          try {
             ...
             const result =  createCategory(name, description, parentCategory , isActive)
      ...
      const handleCategoryStatusChange= (event: React.ChangeEvent<HTMLInputElement>) => {
  ...
  return (
    ...
    <h1 className='text-2xl font-bold text-blue-600 text-center p-4 '>Add new category</h1>
    ...
    <DropdownMenu>
      ...
      <DropdownMenuContent className="w-56">
        ...
        <DropdownMenuRadioGroup value={parentCategory} onValueChange={setParentCategory} >
