  ...
  return (
    ...
    <form onSubmit={formik.handleSubmit} className='md:w-1/3 lg:w-1/4  sm:w-1/2 items-center mx-auto pt-10 border rounded-md p-6 mt-10 '>
      ...
      <div className='pb-3 pt-10 flex flex-col gap-1' >
        ...
        <Input type="email" id='email' name='email' placeholder='Enter your email' value={formik.values.email} onChange={formik.handleChange} className='w-full placeholder:text-gray-300'
        style={{
          width: '100%',
          padding: '8px',
          marginBottom: '5px',
