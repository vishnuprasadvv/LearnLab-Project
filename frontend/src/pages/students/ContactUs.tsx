...
const ContactUs:React.FC = () => {
  return (
    <div className="w-full ">
      ...
      <h1 className="text-3xl font-bold text-gray-800 dark:text-gray-100 mb-4">Contact Us</h1>
      ...
      <h3 className="text-xl font-medium text-gray-800 dark:text-gray-100 mb-2">Support Hours:</h3>
      <p className="text-gray-700 dark:text-gray-300 leading-relaxed">
        Monday to Friday: 9 AM – 6 PM (Local Time) <br />
        Saturday: 10 AM – 4 PM (Local Time) <br />
        Sunday: Closed
      </p>
      <h3 className="text-xl font-medium text-gray-800 dark:text-gray-100 mt-6 mb-2">Follow Us:</h3>
