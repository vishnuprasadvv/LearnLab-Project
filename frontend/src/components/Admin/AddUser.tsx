...
function AddUser() {
    ...
    const formik = useFormik({
        ...
        onSubmit : async(values) => {
          ...
          try {
             ...
             const result =  createUser(firstName, lastName, email, phone, password, role, userStatus)
  ...
  return (
    ...
    <h1 className='text-2xl font-bold text-blue-600 text-center p-4 '>Add new user</h1>
    <Toaster/>
